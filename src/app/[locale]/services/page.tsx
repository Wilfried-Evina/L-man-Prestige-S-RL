...
export default function ServicesPage() {
    ...
    return (
        <div className="min-h-screen bg-[#051622] pt-48 md:pt-56 pb-32">
            <div className="max-w-[1800px] mx-auto px-4 md:px-12">
                    ...
                    {services.map((service) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 p-6 w-full">
                                <h3 className="!text-white text-xl md:text-2xl font-bold mb-2 group-hover:text-[#C5A059] transition-colors duration-300">
                                    {service.title}
                                </h3>
                                <p className="!text-white/70 text-sm font-light line-clamp-2">
                                    {service.description}
                                </p>
                                <div className="mt-4 flex items-center gap-2 text-[#C5A059] uppercase tracking-widest text-xs font-bold opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 delay-100">
                ...
                {/* CTA Section */}
                <div className="py-24 border-t border-white/10 flex items-center justify-center">
                    <div className="max-w-4xl mx-auto text-center px-6 flex flex-col items-center justify-center">
                        <span className="inline-block mb-6 text-[#C5A059] text-xs uppercase tracking-[0.3em] font-bold">
                            Contactez-nous
                        </span>
                        ...
                        <p className="!text-white text-lg md:text-xl mb-12 leading-relaxed max-w-2xl">
                            Contactez-nous pour un devis gratuit et personnalisé. Nous vous répondons sous 24h.
                        </p>
