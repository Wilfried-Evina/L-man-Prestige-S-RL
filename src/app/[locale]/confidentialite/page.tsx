    ...
    return (
        <div className="min-h-screen bg-[#051622] pt-32 pb-32">
            <div className="max-w-[800px] mx-auto px-4 md:px-12">
                <h1 className="text-white text-4xl md:text-5xl font-bold tracking-tight mb-12">
                ...
                <div className="flex flex-col gap-8 text-white/80 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-white text-2xl font-bold mb-4">Données collectées</h2>
                                ...
                                <div className="min-h-screen bg-[#051622] pt-32 pb-32">
                                    <div className="max-w-[800px] mx-auto px-4 md:px-12">
                                        ...
                                        <div className="flex flex-col gap-8 text-white/80 leading-relaxed">
                                            ...
                                            <section>
                                                <h2 className="text-white text-2xl font-bold mb-4">Utilisation des données</h2>
                                            ...
                                            <section>
                                                <h2 className="text-white text-2xl font-bold mb-4">Conservation des données</h2>
                                                <p>
                                            ...
                                            <section>
                                                <h2 className="text-white text-2xl font-bold mb-4">Sécurité</h2>
                                                <p>
                                            ...
                                            <section>
                                                <h2 className="text-white text-2xl font-bold mb-4">Vos droits</h2>
                                            ...
                                            <section>
                                                <h2 className="text-white text-2xl font-bold mb-4">Cookies</h2>
                                                <p>
